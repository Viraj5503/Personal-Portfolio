  ...
  return (
    <section id="skills" className="py-20 bg-white dark:bg-slate-900 transition-colors duration-300">
      <div className="container mx-auto px-4 lg:px-8">
                ...
                {category.skills.map((skill, skillIndex) => (
                  <div key={skillIndex} className="space-y-2">
                    <div className="flex justify-between items-center">
                      <span className="font-medium text-slate-700 dark:text-slate-300 transition-colors duration-300">{skill.name}</span>
                      <Badge variant="secondary" className="text-xs dark:bg-slate-700 dark:text-slate-300 transition-colors duration-300">
                        {skill.category}
                      </Badge>
                    </div>
        ...
        {/* Soft Skills Section */}
        <Card className="mt-8 p-8 shadow-lg border-0 bg-gradient-to-br from-blue-50 to-emerald-50 dark:from-slate-800 dark:to-slate-800 transition-colors duration-300">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-slate-800 dark:text-white mb-4 transition-colors duration-300">Personal Attributes</h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {[
              ...
              <div key={index} className="text-center">
                ...
                <h4 className="font-medium text-slate-800 dark:text-slate-300 text-sm transition-colors duration-300">{item.skill}</h4>
              </div>
            ))}
          </div>
        </Card>
